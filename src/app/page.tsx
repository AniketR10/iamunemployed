    ...
    <div className="min-h-screen bg-[#F8F3E7] font-sans text-gray-900 flex flex-col">
      ...
      <main className="container mx-auto px-4 py-10 text-center grow">
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          <Link href="/startups" className="group p-6 border-2 border-gray-900 rounded-lg bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all">
            ...
            <p className="text-sm font-medium text-gray-600">Access data of thousands of latest funded startups and their Founder Socials.</p>
          </Link>

          <Link href="/yc" className="group p-6 border-2 border-gray-900 rounded-lg bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all">
            ...
            <p className="text-sm font-medium text-gray-600">Browse the complete YC catalog with direct social links.</p>
          </Link>

          <Link href="/reddit" className="group p-6 border-2 border-gray-900 rounded-lg bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all">
            ...
            <p className="text-sm font-medium text-gray-600">Real-time feed of job postings from Reddit.</p>
          </Link>

          <Link href="/companies" className="group p-6 border-2 border-gray-900 rounded-lg bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all">
            <div className="w-12 h-12 bg-[#00A86B] bg-opacity-20 border-2 border-gray-900 rounded-md flex items-center justify-center mb-4 mx-auto group-hover:bg-opacity-30 transition">
              <Laptop size={24} className="text-gray-900" />
            </div>
            <h3 className="text-xl font-black mb-2">Remote Jobs</h3>
            <p className="text-sm font-medium text-gray-600">Discover 800+ remote-first companies hiring worldwide.</p>
          </Link>
